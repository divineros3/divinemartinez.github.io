...
document.addEventListener("click", function(event) {
    //Here we state thata if the click happens on the cancel button OR anywhere that is not the contact form AND the click does not happen on any element with the contact class the call the closeForm() function
